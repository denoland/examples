...
[Digital Ocean](https://digitalocean.com) is a popular cloud infrastructure
provider offering a variety of hosting services ranging from networking, to
compute, to storage.

Here's a step by step guide to deploying a Deno app to Digital Ocean using
Docker and GitHub Actions.

_[View this guide on Deno Manual](https://deno.land/manual/advanced/deploying_deno/digital_ocean)._
...
and push it to the registry. Note that we're applying the tag `new`, which is
